...
return new class extends Migration
{
    ...
    {
        Schema::create('import_guru_histories', function (Blueprint $table) {
        ...
        Schema::create('import_guru_history_items', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('import_guru_history_items');
        Schema::dropIfExists('import_guru_histories');
    }
};
