...
export const landingFeatureCards = [
  ...
  { cat: 'data', icon: 'user-cog', title: 'Manajemen Guru & Admin', desc: 'Kelola data guru, admin sekolah, dan hak akses sesuai peran.' },
  { cat: 'data', icon: 'school', title: 'Kelas & Rombel', desc: 'Atur kelas, anggota kelas, dan riwayat struktur kelas per periode.' },
  ...
  { cat: 'presensi', icon: 'monitor-play', title: 'Live Scan Feed', desc: 'Pantau status scanner dan scan terbaru agar admin cepat melihat masalah presensi.' },
  ...
  { cat: 'sistem', icon: 'building', title: 'Data Sekolah Terpisah', desc: 'Data sekolah, storage, dan akses pengguna dikelola dalam lingkungan yang rapi.' },
...
export const sismuLandingPainPoints = [
  ...
  },
  {
    ...
    desc: 'Informasi presensi, tugas, dan laporan sering terlambat karena data harus direkap manual lebih dulu.'
  },
  {
    icon: 'database-backup',
