      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-lg">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Pindahkan siswa terpilih secara manual. Rollover per kelas dijalankan dari Pengaturan Akademik.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-2 text-sm text-indigo-800">
            Pilih siswa satu per satu agar perubahan kelas lebih aman dan mudah diaudit.
          </div>
