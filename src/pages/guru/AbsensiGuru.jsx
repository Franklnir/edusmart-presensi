  ...
  const renderSiswaTable = (list, type) => {
    ...
    const getSourceInfo = (s) => {
      ...
      if (text.includes('manual') || oleh === user?.id) {
        return (
          <span className="flex items-center gap-1 font-bold text-gray-600 text-xs">
                  ...
                  <tr key={s.id} className={`transition-colors ${rowColors[type]}`}>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-col items-start gap-1">
                        <span
                          className={`px-2 py-0.5 rounded text-[10px] font-bold border uppercase tracking-wide ${badgeColors[type]}`}
                        >
                          {type}
                        </span>
                        {getSourceInfo(s)}
              ...
              <div className="flex items-center gap-3 w-full md:w-auto">
                <div
                  className={`p-2 rounded-lg flex-shrink-0 ${
                    isAbsenOpen ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-500'
                  }`}
                >
            ...
            <div className="flex gap-8 overflow-x-auto">
              {[
                ...
                <button
                  ...
                  className={`py-4 text-sm font-bold border-b-2 flex items-center gap-2 transition-all ${
                    view === tab.key
