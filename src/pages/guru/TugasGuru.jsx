...
========================= */
  ...
  const renderSubmissionCompleteness = (jawaban) => {
    ...
    return (
      <div className="flex flex-wrap items-center gap-2">
        <span className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-xs font-semibold ${summary.className}`}>
  ...
  const renderSubmissionViewer = (siswa, jawaban, options = {}) => {
    ...
    const titleClass = 'block truncate text-xs font-semibold text-slate-900'
                  ...
                  <div className="grid gap-4 lg:grid-cols-[220px_minmax(0,1fr)_220px] lg:items-start">
                    <div className="min-w-0">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="truncate text-sm font-semibold text-slate-900">{siswa.nama}</p>
                    ...
                    {type === 'belum' ? (
                      <div className="flex lg:justify-end">
                        <span className="inline-flex rounded-full border border-rose-200 bg-rose-50 px-3 py-1.5 text-xs font-semibold text-rose-700">
                          Belum mengumpulkan
                        </span>
                      </div>
                    ) : (
                      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3">
                        <div className="mb-2 flex items-center justify-between gap-2">
                          <label htmlFor={`nilai-${siswa.id}`} className="block text-xs font-semibold uppercase tracking-wide text-slate-500">
                            Nilai
                          </label>
                          <span className={`inline-flex rounded-full border px-2.5 py-1 text-[11px] font-semibold ${scoreClass}`}>
                            {scoreLabel}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <button
                            className="inline-flex items-center justify-center gap-1.5 rounded-xl bg-green-600 px-3 py-2 text-xs font-semibold text-white transition-colors hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-60"
                            onClick={(e) => {
                              e.stopPropagation()
                      ...
                      >
                        <div className="flex items-start justify-between gap-3">
                          ...
                          {allSubmittedAndGraded ? (
                            ...
                            <span className="px-2 py-1 rounded-full bg-yellow-100 text-yellow-800 text-xs font-semibold whitespace-nowrap">
                              {needGrade} menunggu
                            </span>
                          ) : isNearDeadline ? (
                            <span className="px-2 py-1 rounded-full bg-yellow-100 text-yellow-800 text-xs font-semibold whitespace-nowrap">
                        ...
                        <div className="mt-4 grid grid-cols-4 gap-2 text-center">
                          <div className="p-2 rounded-xl bg-slate-50 border border-slate-200">
                            ...
                            <div className="font-semibold text-slate-800">{totalSiswa}</div>
                          </div>
